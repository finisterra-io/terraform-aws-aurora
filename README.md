...
| <a name="input_appautoscaling_target_tags"></a> [appautoscaling\_target\_tags](#input\_appautoscaling\_target\_tags) | A map of tags to add to the AppAutoScaling target | `map(string)` | `{}` | no |
...
| <a name="input_autoscaling_policy_type"></a> [autoscaling\_policy\_type](#input\_autoscaling\_policy\_type) | The policy type for the autoscaling policy | `string` | `"TargetTrackingScaling"` | no |
...
| <a name="input_cluster_endpoint"></a> [cluster\_endpoint](#input\_cluster\_endpoint) | Map of additional cluster endpoints and their attributes to be created | `any` | `{}` | no |
...
| <a name="input_db_parameter_group_tags"></a> [db\_parameter\_group\_tags](#input\_db\_parameter\_group\_tags) | A map of tags to add to the DB parameter group | `map(string)` | `{}` | no |
...
| <a name="input_db_subnet_group_tags"></a> [db\_subnet\_group\_tags](#input\_db\_subnet\_group\_tags) | A map of tags to add to the DB subnet group | `map(string)` | `{}` | no |
...
| <a name="input_kms_key_alias"></a> [kms\_key\_alias](#input\_kms\_key\_alias) | The alias of the KMS key | `string` | `null` | no |
...
| <a name="input_monitoring_role_description"></a> [monitoring\_role\_description](#input\_monitoring\_role\_description) | The description of the monitoring role | `string` | `null` | no |
| <a name="input_monitoring_role_max_session_duration"></a> [monitoring\_role\_max\_session\_duration](#input\_monitoring\_role\_max\_session\_duration) | The maximum session duration (in seconds) that you want to set for the monitoring role | `number` | `3600` | no |
| <a name="input_monitoring_role_name"></a> [monitoring\_role\_name](#input\_monitoring\_role\_name) | The name of the monitoring role | `string` | `null` | no |
| <a name="input_monitoring_role_path"></a> [monitoring\_role\_path](#input\_monitoring\_role\_path) | The path of the monitoring role | `string` | `"/"` | no |
| <a name="input_monitoring_role_permissions_boundary"></a> [monitoring\_role\_permissions\_boundary](#input\_monitoring\_role\_permissions\_boundary) | The ARN of the policy that is used to set the permissions boundary for the monitoring role | `string` | `null` | no |
| <a name="input_monitoring_role_tags"></a> [monitoring\_role\_tags](#input\_monitoring\_role\_tags) | A map of tags to add to the monitoring role | `map(string)` | `{}` | no |
...
| <a name="input_performance_insights_kms_key_alias"></a> [performance\_insights\_kms\_key\_alias](#input\_performance\_insights\_kms\_key\_alias) | The alias of the Performance Insights KMS key | `string` | `null` | no |
...
| <a name="input_scalable_dimension"></a> [scalable\_dimension](#input\_scalable\_dimension) | The scalable dimension for the scalable target | `string` | `"rds:cluster:ReadReplicaCount"` | no |
...
| <a name="input_service_namespace"></a> [service\_namespace](#input\_service\_namespace) | The namespace of the AWS service | `string` | `"rds"` | no |
